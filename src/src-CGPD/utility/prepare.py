...
class DataPreparation:
    ...
    def __init__(self, args):
        ...
        #dis
        self.chem_dis_adj = pickle.load(open(args.adj_pkl_path + "chem_dis_adj.pkl", "rb"))
        self.gene_dis_adj = pickle.load(open(args.adj_pkl_path + "gene_dis_adj.pkl", "rb"))
        self.dis_chem_adj = pickle.load(open(args.adj_pkl_path + "dis_chem_adj.pkl", "rb"))
        self.dis_gene_adj = pickle.load(open(args.adj_pkl_path + "dis_gene_adj.pkl", "rb"))
        ### chem-gene; gene-chem
        ...
        #dis
        self.chem_dis_deg = pickle.load(open(args.adj_pkl_path + "chem_dis_deg.pkl", "rb"))
        self.gene_dis_deg = pickle.load(open(args.adj_pkl_path + "gene_dis_deg.pkl", "rb"))
        self.dis_chem_deg = pickle.load(open(args.adj_pkl_path + "dis_chem_deg.pkl", "rb"))
        self.dis_gene_deg = pickle.load(open(args.adj_pkl_path + "dis_gene_deg.pkl", "rb"))
        # chem-gene; gene-chem
    ...
    def set_adj_dict(self):
        ...
        self.adj_dict_s1 = {
            ...
            (1, 3): [self.gene_dis_adj],
            (3, 0): [self.dis_chem_adj],
            (3, 1): [self.dis_gene_adj],
            (0, 3): [self.chem_path_adj],
        }
        self.adj_dict_s2 = {
    ...
    def set_deg_dict(self):
        self.deg_dict_s1 = {
            ...
            (1, 3): [self.gene_dis_deg],
            (3, 0): [self.dis_chem_deg],
            (3, 1): [self.dis_gene_deg],
            (0, 3): [self.chem_dis_deg],
        }
        self.deg_dict_s2 = {
    ...
    def set_feat_dict(self):
        ...
        dis_feat = sp.identity(self.n_diss, dtype=float)
        dis_nonzero_feat_num, dis_feat_num = dis_feat.shape
        self.feat_dict = {
            0: chem_feat,
            1: gene_feat,
            2: path_feat,
