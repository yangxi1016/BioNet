...
class Handler():
    ...
    def gen_tr_va_te_edges(self, rel_type, type_idx):
        ...
        num_va = max(20, int(np.floor(edges_all.shape[0] * self.args.va_te_rate)))
        num_te = max(20, int(np.floor(edges_all.shape[0] * self.args.va_te_rate)))
    ...
    def save_edges_pkl(self):
        pickle.dump(self.tr_edges, open(self.args.edg_pkl_path + "tr_edges.pkl", 'wb'))
        pickle.dump(self.va_edges, open(self.args.edg_pkl_path + "va_edges.pkl", 'wb'))
        pickle.dump(self.te_edges, open(self.args.edg_pkl_path + "te_edges.pkl", 'wb'))
        pickle.dump(self.va_false_edges, open(self.args.edg_pkl_path + "va_false_edges.pkl", 'wb'))
        pickle.dump(self.te_false_edges, open(self.args.edg_pkl_path + "te_false_edges.pkl", 'wb'))
        pickle.dump(self.adj_dict_s1_tr, open(self.args.edg_pkl_path + "adj_dict_s1_tr.pkl", 'wb'))
        pickle.dump(self.adj_dict_s2_tr, open(self.args.edg_pkl_path + "adj_dict_s2_tr.pkl", 'wb'))


def gen_edg():
    args = parser.parse_args()
    mkdir(args.edg_pkl_path)
    log = logger(args.edg_pkl_path + args.log_file)
