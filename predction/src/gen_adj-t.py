...
class Handler():
    def __init__(self, arg, log):
        ...
        self.chem_gene_list_disease = None
    ...
    def load_raw_pkl(self):
        ...
        self.chem1_chem2_list = pickle.load(open(self.arg.raw_pkl_path + "chem1_chem2_list.pkl", "rb"))
        self.gene1_gene2_list = pickle.load(open(self.arg.raw_pkl_path + "gene1_gene2_list.pkl", "rb"))
        self.chem_path_list = pickle.load(open(self.arg.raw_pkl_path + "chem_pathway_list.pkl", "rb"))
        self.gene_path_list = pickle.load(open(self.arg.raw_pkl_path + "gene_pathway_list.pkl", "rb"))
        self.chem_gene_list = pickle.load(open(self.arg.raw_pkl_path + "chem_gene_tiny_list.pkl", "rb"))
        #self.chem_gene_list_disease = pickle.load(open(self.arg.raw_pkl_path + "chem_gene_tiny_list.pkl", "rb"))
        self.chem_gene_list_disease = pickle.load(open(self.arg.raw_pkl_path + "chem_gene_list_CDH2.pkl", "rb"))
        ...
        if is_tiny:
            ...
            list5 = [ins for ins in self.chem_gene_list if ins[2] == "increases^ubiquitination"][0:2000]
            list6 = [ins for ins in self.chem_gene_list if ins[2] == "decreases^transport"][0:2000]
            self.chem_gene_list = list1 + list2 + list3 + list4
    ...
    def construct_chem_gene_adj(self):
        ...
        for each in self.chem_gene_list_disease:
            self.chem_gene_dict[each[2]].append((each[0], each[1], each[3]))  # (cid, gid, relation, direction)

        i = 0
        rel_num = open(self.arg.adj_pkl_path + "rel_num.txt", "w")
        for rel in list(self.chem_gene_dict.keys()):
            ...
            # self.chem_gene_adj_list.append(mat)
    ...
    def save_adj_pkl(self):
        ...
        # dictionary
        pickle.dump(self.cid2num_dict, open(self.arg.adj_pkl_path + "cid2num_dict.pkl", "wb"))
        pickle.dump(self.num2cid_dict, open(self.arg.adj_pkl_path + "num2cid_dict.pkl", "wb"))
        pickle.dump(self.gid2num_dict, open(self.arg.adj_pkl_path + "gid2num_dict.pkl", "wb"))
        pickle.dump(self.num2gid_dict, open(self.arg.adj_pkl_path + "num2gid_dict.pkl", "wb"))
        pickle.dump(self.pid2num_dict, open(self.arg.adj_pkl_path + "pid2num_dict.pkl", "wb"))
        pickle.dump(self.num2pid_dict, open(self.arg.adj_pkl_path + "num2pid_dict.pkl", "wb"))

        # chem1-chem2; chem2-chem1; gene1-gene2; gene2-gene1
        pickle.dump(self.chem1_chem2_adj, open(self.arg.adj_pkl_path + "chem1_chem2_adj.pkl", 'wb'))
        pickle.dump(self.gene1_gene2_adj, open(self.arg.adj_pkl_path + "gene1_gene2_adj.pkl", 'wb'))
        pickle.dump(self.chem2_chem1_adj, open(self.arg.adj_pkl_path + "chem2_chem1_adj.pkl", 'wb'))
        pickle.dump(self.gene2_gene1_adj, open(self.arg.adj_pkl_path + "gene2_gene1_adj.pkl", 'wb'))
        pickle.dump(self.chem1_chem2_deg, open(self.arg.adj_pkl_path + "chem1_chem2_deg.pkl", 'wb'))
        pickle.dump(self.gene1_gene2_deg, open(self.arg.adj_pkl_path + "gene1_gene2_deg.pkl", 'wb'))
        pickle.dump(self.chem2_chem1_deg, open(self.arg.adj_pkl_path + "chem2_chem1_deg.pkl", 'wb'))
        pickle.dump(self.gene2_gene1_deg, open(self.arg.adj_pkl_path + "gene2_gene1_deg.pkl", 'wb'))

        # chem-path; path-chem; gene-path; path-gene
        pickle.dump(self.chem_path_adj, open(self.arg.adj_pkl_path + "chem_path_adj.pkl", 'wb'))
        pickle.dump(self.gene_path_adj, open(self.arg.adj_pkl_path + "gene_path_adj.pkl", 'wb'))
        pickle.dump(self.path_chem_adj, open(self.arg.adj_pkl_path + "path_chem_adj.pkl", 'wb'))
        pickle.dump(self.path_gene_adj, open(self.arg.adj_pkl_path + "path_gene_adj.pkl", 'wb'))
        pickle.dump(self.chem_path_deg, open(self.arg.adj_pkl_path + "chem_path_deg.pkl", 'wb'))
        pickle.dump(self.gene_path_deg, open(self.arg.adj_pkl_path + "gene_path_deg.pkl", 'wb'))
        pickle.dump(self.path_chem_deg, open(self.arg.adj_pkl_path + "path_chem_deg.pkl", 'wb'))
        pickle.dump(self.path_gene_deg, open(self.arg.adj_pkl_path + "path_gene_deg.pkl", 'wb'))

        # chem-gene; gene-chem
        pickle.dump(self.chem_gene_adj_list, open(self.arg.adj_pkl_path + "chem_gene_adj_list.pkl", 'wb'))
        pickle.dump(self.gene_chem_adj_list, open(self.arg.adj_pkl_path + "gene_chem_adj_list.pkl", 'wb'))
        pickle.dump(self.chem_gene_deg_list, open(self.arg.adj_pkl_path + "chem_gene_deg_list.pkl", 'wb'))
        pickle.dump(self.gene_chem_deg_list, open(self.arg.adj_pkl_path + "gene_chem_deg_list.pkl", 'wb'))

def gen_adj():
    arg = parser.parse_args()
    log = logger(arg.log_file)
    log.info("Running gen_adj.py")
    mkdir(arg.adj_pkl_path)
